...
### 投资机构 · VC
- Sequoia Capital · `@sequoiacapital` — Training Data 播客,顶级 VC 看 AI 大盘
- a16z · `@a16z` — AI 趋势 + 创始人深访,增长/出海视角
- Y Combinator · `@ycombinator` — Lightcone 播客,创业一线判断
- Redpoint AI · `@redpointai` — Unsupervised Learning 播客

### 前沿 AI 公司 · 官方
- OpenAI · `@OpenAI` — 发布会 / demo 第一现场
- Anthropic · `@anthropic-ai` — Claude + 安全/可解释研究
- Google DeepMind · `@googledeepmind` — 前沿模型研究
- HeyGen · `@HeyGen_Official` — 产品即内容,出海 GTM 范本
- Notion · `@Notion` — AI 产品 + GTM / 模板

### 一线 researcher · 长访谈
- Andrej Karpathy · `@AndrejKarpathy` — 第一性原理教学
- Lex Fridman · `@lexfridman` — 和造 AI 的人几小时深聊

### 播客 · 工程/产品
- Latent Space · `@LatentSpacePod` — swyx,AI 工程最硬核
- Lenny's Podcast · `@LennysPodcast` — 产品/增长,最贴 GTM
- No Priors · `@NoPriorsPodcast` — 模型公司创始人深访

### influencer · 科普/评测(广度)
- Two Minute Papers · `@TwoMinutePapers` — 最新论文几分钟人话
- AI Explained · `@aiexplained-official` — 抠模型与 benchmark
- Matthew Berman · `@matthew_berman` — 新模型/agent 第一时间 demo
- AI Jason · `@AIJasonZ` — agent/编码实操 demo
- bycloud · `@bycloudAI` — 模型研究/新论文,偏技术

---

## Twitter / X(36)

> 同步至 `my_builders.txt`(脚本抓取)。格式:显示名 @handle。

### 研究 / Labs
Andrej Karpathy @karpathy · Sam Altman @sama · Greg Brockman @gdb · Yann LeCun @ylecun · Andrew Ng @AndrewYNg · Jim Fan @DrJimFan · Fei-Fei Li @drfeifei · Demis Hassabis @demishassabis · Noam Brown @polynoamial · Nathan Lambert @natolambert · Ethan Mollick @emollick

### 模型公司 · 官方
DeepSeek @deepseek_ai · MiniMax @MiniMax__AI

### 创始 / 产品 CEO
Aravind Srinivas @AravSrinivas · Amjad Masad @amasad · Alexandr Wang @alexandr_wang · Clement Delangue @ClementDelangue · Harrison Chase @hwchase17 · Michael Truell @mntruell · Guillermo Rauch @rauchg · Bret Taylor @btaylor · Mira Murati @miramurati

### GTM / 增长 / 出海
Lenny Rachitsky @lennysan · Greg Isenberg @gregisenberg · Peter Yang @petergyang · Pieter Levels @levelsio

### demo / builder 高产
AK @_akhaliq · Mckay Wrigley @mckaywrigley · Bilawal Sidhu @bilawalsidhu · Riley Brown @rileybrown_ai

### 工程 / 写作
swyx @swyx · Simon Willison @simonw

### 投资 & 操盘
Garry Tan @garrytan · Sarah Guo @saranormous · Martin Casado @martin_casado

### 业内 influencer · 对标
Zara Zhang 张咋啦 @zarazhangrui — 文科转 AI · build in public
...
> 个人账号管理 + AI 博主关注池。当前 Frontier 管线**暂未自动抓取小红书**,作为关注/选题源。
